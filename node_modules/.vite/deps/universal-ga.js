...
// node_modules/universal-ga/lib/analytics.js
var require_analytics = __commonJS({
  "node_modules/universal-ga/lib/analytics.js"(exports, module) {
    (function(global) {
      "use strict";
      function warn(s) {
      ...
      Analytics.prototype = {
        initialize: function(trackingID, options) {
          ...
          if (trackingID) {
            options = JSON.stringify(options) === "{}" ? void 0 : options;
...
universal-ga/lib/analytics.js:
   ...
   *)
*/
//# sourceMappingURL=universal-ga.js.map
