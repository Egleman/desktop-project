...
// node_modules/@panter/vue-i18next/node_modules/deepmerge/dist/es.js
...
// node_modules/@panter/vue-i18next/dist/vue-i18next.esm.js
var component = {
  name: "i18next",
  functional: true,
  props: {
  ...
  render: function render(h, ref) {
    ...
    var i18nextOptions = Object.assign(
      {},
      options,
...
function t(el, binding, vnode) {
  ...
  var vm = vnode.context;
  el.textContent = vm.$i18n.i18next.t(path, Object.assign(
    {},
...
function install(_Vue) {
    ...
    beforeCreate: function beforeCreate() {
      ...
      if (this._i18n) {
        ...
        if (options.i18nOptions) {
          ...
          if (messages) {
            inlineTranslations = es_default(inlineTranslations, messages);
          }
      ...
      if (this._i18nOptions && this._i18nOptions.namespaces) {
        ...
        this._getI18nKey = function(key, i18nextOptions) {
          return fixedT(getKey(key), i18nextOptions, this$1._i18n.i18nLoadedAt);
        };
      } else {
        this._getI18nKey = function(key, i18nextOptions) {
          return this$1._i18n.t(getKey(key), i18nextOptions, this$1._i18n.i18nLoadedAt);
        };
      }
    }
  });
  ...
  Vue.prototype.$t = function t3(key, options) {
...
var VueI18n = function VueI18n2(i18next, opts) {
  if (opts === void 0)
    opts = {};
  ...
  this.resetVM({ i18nLoadedAt: /* @__PURE__ */ new Date() });
};
...
VueI18n.prototype.t = function t2(key, options) {
...
var vue_i18next_esm_default = VueI18n;
export {
  vue_i18next_esm_default as default
};
//# sourceMappingURL=@panter_vue-i18next.js.map
