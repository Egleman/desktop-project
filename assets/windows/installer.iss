; ------------------------------------------
; Installer for SKYS Configurator
; ------------------------------------------
...
#define ApplicationName "SKYS Configurator"
#define CompanyName "The SKYS open source project"
#define CompanyUrl "https://SKYS.com/"
#define ExecutableFileName "SKYS-configurator.exe"
#define GroupName "SKYS"
#define InstallerFileName "SKYS-configurator_" + version + "_" + archName + "-installer"
#define SourcePath "..\..\" + sourceFolder + "\SKYS-configurator\" + archName
#define TargetFolderName "SKYS-Configurator"
#define UpdatesUrl "https://github.com/SKYS/SKYS-configurator/releases"

[CustomMessages]
AppName=SKYS-configurator
...
begin
    ...
    if not RegQueryStringValue(HKLM, 'SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\SKYS Configurator', 'UninstallString', Result) then
    begin
        if not RegQueryStringValue(HKLM, 'SOFTWARE\WOW6432Node\Microsoft\Windows\CurrentVersion\Uninstall\SKYS Configurator', 'UninstallString', Result) then
        begin
            RegQueryStringValue(HKCU, 'SOFTWARE\SKYS\SKYS Configurator', 'UninstallString', Result)
        end;
    end;
end;
