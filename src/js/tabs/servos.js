...
servos.initialize = function (callback) {
    ...
    function update_ui() {
        ...
        for (let i = 0; i < FC.RC.active_channels; i++) {
            servoCheckbox += `<td class="channel "><input type="checkbox" class="checkbox-round" /></td>`;
        }
        ...
        */
        ...
        function process_servos(name, obj) {
            ...
            let element = `<tr class="h53px" ><td style="text-align: center">${name}</td>`;
        ...
        */
        ...
        for (let servoIndex = 0; servoIndex < 8; servoIndex++) {
            process_servos(`Серво ${servoIndex+1}`, servoIndex);
        }
